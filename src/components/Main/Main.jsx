...
const Main = () => {
    ...
    return (
        <div className='relative flex flex-col justify-between flex-1 min-h-screen pb-8'>
            <nav id="navbar" className='flex items-center justify-between px-2 py-1'>
                ...
                <div id="nav-right" className='flex items-center gap-5'>
                    <div id="btn" className='flex items-center gap-2 p-2 px-5 text-sm bg-gray-200 rounded-lg cursor-pointer hover:bg-zinc-300'>
            ...
            </nav>
            {
                !showResult ? <center id="greet-container">
                    ...
                    <div id='result' className='flex flex-col px-24 h-screen max-h-[70vh] overflow-y-scroll'>
                        ...
                        <div id="result-body" className='flex items-start gap-5'>
                            <img src={gemini} alt="" />
                            {
                                loading ? <div className='flex flex-col w-full loader'>
                                    ...
                                    <hr />
                                    <hr />
                                </div> : <p className='text-lg font-light leading-5' dangerouslySetInnerHTML={{ __html: resultData }}></p>
                            }
